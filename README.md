# Superseded — see the portfolios below

This repository used to be a hand-maintained index. It has been replaced by the profile
README and five capability portfolios, which are kept current and state clearly what is
...
*The previous version of this page linked several repositories as completed work that were
in fact unbuilt specifications. That is why it was replaced.*
